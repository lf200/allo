...
import com.example.secaicontainerengine.annotation.AuthCheck;
import com.example.secaicontainerengine.common.BaseResponse;
import com.example.secaicontainerengine.common.DeleteRequest;
...
import com.example.secaicontainerengine.pojo.dto.user.*;
...
public class UserController {
     ...
     * @return
     */
    // 都是默认密码，userAddRequest没有密码字段，因为这是管理员使用的添加用户的方法
    @PostMapping("/add")
